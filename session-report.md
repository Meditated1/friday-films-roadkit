...
Session date: June 4–5, 2026 · Move date: **Friday, July 3, 2026** (🎆 Independence Day weekend) · 🐾 traveling with cats
...
### The 4 days
| Day | Date | Route | Miles | Hrs | Overnight |
|-----|------|-------|------:|----:|-----------|
| 1 | Fri Jul 3 | Salina → **Oklahoma City** | 290 | 4.5 | OKC (I-40 @ Meridian) |
| 2 | Sat Jul 4 🎆 | OKC → **Memphis** | 465 | 7 | Memphis EAST (I-40 Exit 16, not downtown) |
| 3 | Sun Jul 5 | Memphis → **Montgomery** | 330 | 5 | Montgomery (I-85 EastChase) |
| 4 | Mon Jul 6 | Montgomery → **Leesburg** 🏁 | 470 | 7 | home (34407 Shadewood Cir) |
...
- **Tolls: $0**
- **Trip total (fuel + hotels): ~$1,613** (+ pet fees + food extra)
...
- **Night 2 (Sat Jul 4 🎆) – Memphis East:** **Hilton Garden Inn Wolfchase** — ~$176 *(🐾 cats; 🚛 big standalone lot in the IKEA/Wolfchase retail zone, indoor pool)*
  - alts: Hampton Wolfchase ($172, large free lot), Residence Inn Germantown ($180, smaller lot — fills evening)
- **Night 3 (Sun Jul 5) – Montgomery:** **TownePlace Suites EastChase** — ~$156 *(🐾 cats; 🚛 flat, often-empty lot — best for the trailer, suite + kitchen)* ← switched here for parking
  - alts: Hilton Garden Inn Montgomery East ($150, free lot); Hampton EastChase ($168, highest-rated 4.7★ BUT lot is on a steep hill — only if you confirm a flat end spot)

**🐾 Pet policy:** all confirmed cat-friendly; pet fee ~$50–75/stay; **call each 24–48h ahead to reconfirm cats (not just "pets") + the fee** — some properties quietly limit to dogs.

**Agreed workflow:** Thomas finalizes the 3 hotels → tells Claude → Claude locks them into all files. No auto-sync between Excel and the web files.

**🚛 Trailer parking:** verified for all picks — Home2 (RV/bus/truck), HGI Wolfchase (big lot), TownePlace Montgomery (flat/empty) are the best of each night. Dropped Montgomery Hampton from default because its lot is on a steep hill. **⚠️ Booking:** July 4th weekend sells out — book ASAP (esp. Saturday Memphis). Call front desks day-of to grab a corner/perimeter section.
...
- [ ] **Finalize the 3 cat-friendly hotels** (or confirm the defaults) and BOOK SOON — July 4th weekend sells out.
...
## 6b. DEPARTURE DATE — DECIDED: **Friday, July 3, 2026** (Independence Day weekend)
Thomas chose July 3. **All files now reflect July 3 + holiday hotel rates.** This puts the convoy on the road on **July 4th itself** (Sat) — driving OKC→Memphis and sleeping in Memphis the night of the 4th. Notes that drove the decision:
...
- **Hotels:** July 3–5 is the Independence Day weekend, and 2026 is the **250th anniversary** (extra demand). Our interstate hotels run roughly **+20–40%**, heaviest on **Sat July 4 (Memphis night)**.
  - Now built in: **~$992** (3 nts × 2 rooms, holiday rates) vs the old ~$796 baseline — about **$200 more**, plus ~$50–75/night pet fees for the cats, plus tighter availability (book NOW).
...
- **Trade-off accepted:** ~$200 more in hotels + holiday traffic, in exchange for the July 3 timing. **Mitigation: book hotels immediately** (holiday weekend) and keep an eye on record July 4th traffic when towing.

---

## 7. Open / parking lot
- Hotels not yet booked (cat-friendly defaults set, holiday rates) — **book ASAP**, July 4th weekend.
- ✅ Departure date DECIDED: **Friday July 3** — all files updated.
- ✅ Cat-friendly hotels verified & swapped in (Courtyards dropped — not pet-friendly).
